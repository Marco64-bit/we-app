...
export default function Home() {
    ...
    let {data} =await
    axios.get(`https://api.themoviedb.org/3/trending/${MediaType}/day?api_key=eba8b9a7199efdcb0ca1f96879b83c44&fbclid=IwAR2kArrFYlDYF7UV-44Zl3L5UI9sH1UgIXv9N4SrIzcIZb070ZVCbCgfR7A`);
